...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PumpLine.name'
        db.add_column('lizard_waterbalance_pumpline', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PumpLine.name'
        db.delete_column('lizard_waterbalance_pumpline', 'name')
