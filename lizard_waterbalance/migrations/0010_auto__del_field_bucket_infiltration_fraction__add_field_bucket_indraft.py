...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bucket.indraft_fraction'
        db.add_column('lizard_waterbalance_bucket', 'indraft_fraction', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Bucket.infiltration_fraction'
        db.add_column('lizard_waterbalance_bucket', 'infiltration_fraction', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Deleting field 'Bucket.indraft_fraction'
        db.delete_column('lizard_waterbalance_bucket', 'indraft_fraction')
