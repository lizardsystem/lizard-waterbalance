...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.drained'
        db.add_column('lizard_waterbalance_openwater', 'drained', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.hardened'
        db.add_column('lizard_waterbalance_openwater', 'hardened', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.flow_off'
        db.add_column('lizard_waterbalance_openwater', 'flow_off', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.drained'
        db.delete_column('lizard_waterbalance_openwater', 'drained_id')

        # Deleting field 'OpenWater.hardened'
        db.delete_column('lizard_waterbalance_openwater', 'hardened_id')

        # Deleting field 'OpenWater.flow_off'
        db.delete_column('lizard_waterbalance_openwater', 'flow_off_id')
