...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'OpenWater.sluice_error'
        db.delete_column('lizard_waterbalance_openwater', 'sluice_error_id')

        # Deleting field 'OpenWater.bucket_ptr'
        db.delete_column('lizard_waterbalance_openwater', 'bucket_ptr_id')

        # Adding field 'OpenWater.id'
        db.add_column('lizard_waterbalance_openwater', 'id', self.gf('django.db.models.fields.AutoField')(default=0, primary_key=True), keep_default=False)

        # Adding field 'OpenWater.name'
        db.add_column('lizard_waterbalance_openwater', 'name', self.gf('django.db.models.fields.CharField')(default='empty', max_length=64), keep_default=False)

        # Adding field 'OpenWater.slug'
        db.add_column('lizard_waterbalance_openwater', 'slug', self.gf('django.db.models.fields.CharField')(default='empty', max_length=64), keep_default=False)

        # Adding field 'OpenWater.seepage'
        db.add_column('lizard_waterbalance_openwater', 'seepage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Changing field 'Bucket.open_water'
        db.alter_column('lizard_waterbalance_bucket', 'open_water_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.OpenWater']))


    def backwards(self, orm):
        
        # Adding field 'OpenWater.sluice_error'
        db.add_column('lizard_waterbalance_openwater', 'sluice_error', self.gf('django.db.models.fields.related.ForeignKey')(related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie'], blank=True), keep_default=False)

        # We cannot add back in field 'OpenWater.bucket_ptr'
        raise RuntimeError(
            "Cannot reverse this migration. 'OpenWater.bucket_ptr' and its values cannot be restored.")

        # Deleting field 'OpenWater.id'
        db.delete_column('lizard_waterbalance_openwater', 'id')

        # Deleting field 'OpenWater.name'
        db.delete_column('lizard_waterbalance_openwater', 'name')

        # Deleting field 'OpenWater.slug'
        db.delete_column('lizard_waterbalance_openwater', 'slug')

        # Deleting field 'OpenWater.seepage'
        db.delete_column('lizard_waterbalance_openwater', 'seepage_id')

        # Changing field 'Bucket.open_water'
        db.alter_column('lizard_waterbalance_bucket', 'open_water_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Bucket']))
