...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PumpingStation.open_water'
        db.alter_column('lizard_waterbalance_pumpingstation', 'open_water_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.OpenWater']))


    def backwards(self, orm):
        
        # Changing field 'PumpingStation.open_water'
        db.alter_column('lizard_waterbalance_pumpingstation', 'open_water_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_waterbalance.OpenWater']))
