...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.crop_evaporation_factor'
        db.add_column('lizard_waterbalance_openwater', 'crop_evaporation_factor', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.crop_evaporation_factor'
        db.delete_column('lizard_waterbalance_openwater', 'crop_evaporation_factor')
