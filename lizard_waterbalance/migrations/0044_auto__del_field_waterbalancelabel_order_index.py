...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WaterbalanceLabel.order_index'
        db.delete_column('lizard_waterbalance_waterbalancelabel', 'order_index')


    def backwards(self, orm):
        
        # Adding field 'WaterbalanceLabel.order_index'
        db.add_column('lizard_waterbalance_waterbalancelabel', 'order_index', self.gf('django.db.models.fields.IntegerField')(default=0, unique=True), keep_default=False)
    ...
    models = {
        ...
        'lizard_waterbalance.waterbalancelabel': {
            'Meta': {'object_name': 'WaterbalanceLabel'},
