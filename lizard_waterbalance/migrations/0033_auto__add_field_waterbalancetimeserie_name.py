...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterbalanceTimeserie.name'
        db.add_column('lizard_waterbalance_waterbalancetimeserie', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterbalanceTimeserie.name'
        db.delete_column('lizard_waterbalance_waterbalancetimeserie', 'name')
