...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bucket.upper_drainage_fraction'
        db.add_column('lizard_waterbalance_bucket', 'upper_drainage_fraction', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'Bucket.upper_indraft_fraction'
        db.add_column('lizard_waterbalance_bucket', 'upper_indraft_fraction', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bucket.upper_drainage_fraction'
        db.delete_column('lizard_waterbalance_bucket', 'upper_drainage_fraction')

        # Deleting field 'Bucket.upper_indraft_fraction'
        db.delete_column('lizard_waterbalance_bucket', 'upper_indraft_fraction')
