...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lizard_waterbalance_timeseriesfews', (
            ...
            ('fews_parameter', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_fewsunblobbed.Parameter'])),
            ('fews_filter', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsunblobbed.Filter'], null=True, blank=True)),
            ('fews_location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_fewsunblobbed.Location'])),
        ))
