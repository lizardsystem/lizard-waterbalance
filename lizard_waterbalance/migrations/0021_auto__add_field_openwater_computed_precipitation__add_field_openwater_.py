...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.computed_precipitation'
        db.add_column('lizard_waterbalance_openwater', 'computed_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.computed_evaporation'
        db.add_column('lizard_waterbalance_openwater', 'computed_evaporation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.computed_seepage'
        db.add_column('lizard_waterbalance_openwater', 'computed_seepage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.computed_infiltration'
        db.add_column('lizard_waterbalance_openwater', 'computed_infiltration', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.computed_precipitation'
        db.delete_column('lizard_waterbalance_openwater', 'computed_precipitation_id')

        # Deleting field 'OpenWater.computed_evaporation'
        db.delete_column('lizard_waterbalance_openwater', 'computed_evaporation_id')

        # Deleting field 'OpenWater.computed_seepage'
        db.delete_column('lizard_waterbalance_openwater', 'computed_seepage_id')

        # Deleting field 'OpenWater.computed_infiltration'
        db.delete_column('lizard_waterbalance_openwater', 'computed_infiltration_id')
