...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.surface'
        db.add_column('lizard_waterbalance_openwater', 'surface', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.surface'
        db.delete_column('lizard_waterbalance_openwater', 'surface')
