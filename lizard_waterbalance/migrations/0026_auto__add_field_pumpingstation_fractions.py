...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PumpingStation.fractions'
        db.add_column('lizard_waterbalance_pumpingstation', 'fractions', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PumpingStation.fractions'
        db.delete_column('lizard_waterbalance_pumpingstation', 'fractions_id')
