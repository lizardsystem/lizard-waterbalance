...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Concentration.increment'
        db.alter_column('lizard_waterbalance_concentration', 'increment', self.gf('django.db.models.fields.IntegerField')(default=0))
    ...
    models = {
        ...
        'lizard_waterbalance.concentration': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'increment': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
