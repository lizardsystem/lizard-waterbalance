...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeseriesFews.default_value'
        db.add_column('lizard_waterbalance_timeseriesfews', 'default_value', self.gf('django.db.models.fields.FloatField')(default=0.0, null=True, blank=True), keep_default=False)

        # Adding field 'TimeseriesFews.stick_to_last_value'
        db.add_column('lizard_waterbalance_timeseriesfews', 'stick_to_last_value', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TimeseriesFews.default_value'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'default_value')

        # Deleting field 'TimeseriesFews.stick_to_last_value'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'stick_to_last_value')
