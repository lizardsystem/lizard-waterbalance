...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TimeseriesFews.name'
        db.add_column('lizard_waterbalance_timeseriesfews', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)

        # Adding field 'Timeseries.name'
        db.add_column('lizard_waterbalance_timeseries', 'name', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TimeseriesFews.name'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'name')

        # Deleting field 'Timeseries.name'
        db.delete_column('lizard_waterbalance_timeseries', 'name')
