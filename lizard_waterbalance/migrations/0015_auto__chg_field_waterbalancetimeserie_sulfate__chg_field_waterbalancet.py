...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'WaterbalanceTimeserie.sulfate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'sulfate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.label'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_waterbalance.WaterbalanceLabel'], null=True))

        # Changing field 'WaterbalanceTimeserie.volume'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'volume_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Timeseries']))

        # Changing field 'WaterbalanceTimeserie.phosphate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'phosphate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.nitrate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'nitrate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.chloride'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'chloride_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_fewsunblobbed.Timeserie']))


    def backwards(self, orm):
        
        # Changing field 'WaterbalanceTimeserie.sulfate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'sulfate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.label'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'label_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['lizard_waterbalance.WaterbalanceLabel']))

        # Changing field 'WaterbalanceTimeserie.volume'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'volume_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_waterbalance.Timeseries']))

        # Changing field 'WaterbalanceTimeserie.phosphate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'phosphate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.nitrate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'nitrate_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_fewsunblobbed.Timeserie']))

        # Changing field 'WaterbalanceTimeserie.chloride'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'chloride_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['lizard_fewsunblobbed.Timeserie']))
    ...
    models = {
        ...
        'lizard_waterbalance.waterbalancetimeserie': {
            ...
            'chloride': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_fewsunblobbed.Timeserie']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'label': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lizard_waterbalance.WaterbalanceLabel']", 'null': 'True', 'blank': 'True'}),
            'nitrate': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_fewsunblobbed.Timeserie']"}),
            'phosphate': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_fewsunblobbed.Timeserie']"}),
            'sulfate': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_fewsunblobbed.Timeserie']"}),
