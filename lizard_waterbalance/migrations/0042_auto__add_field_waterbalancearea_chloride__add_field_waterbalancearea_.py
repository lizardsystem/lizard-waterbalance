...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterbalanceArea.chloride'
        db.add_column('lizard_waterbalance_waterbalancearea', 'chloride', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'WaterbalanceArea.phosphate'
        db.add_column('lizard_waterbalance_waterbalancearea', 'phosphate', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterbalanceArea.chloride'
        db.delete_column('lizard_waterbalance_waterbalancearea', 'chloride_id')

        # Deleting field 'WaterbalanceArea.phosphate'
        db.delete_column('lizard_waterbalance_waterbalancearea', 'phosphate_id')
    ...
    models = {
        ...
        'lizard_waterbalance.waterbalancearea': {
            ...
            'chloride': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_waterbalance.WaterbalanceTimeserie']"}),
            ...
            'phosphate': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_waterbalance.WaterbalanceTimeserie']"}),
