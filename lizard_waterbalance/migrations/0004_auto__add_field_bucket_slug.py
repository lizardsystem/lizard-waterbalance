...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bucket.slug'
        db.add_column('lizard_waterbalance_bucket', 'slug', self.gf('django.db.models.fields.CharField')(default=1.0, max_length=64), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bucket.slug'
        db.delete_column('lizard_waterbalance_bucket', 'slug')
