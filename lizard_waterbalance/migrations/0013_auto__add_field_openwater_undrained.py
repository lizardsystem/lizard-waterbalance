...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.undrained'
        db.add_column('lizard_waterbalance_openwater', 'undrained', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.undrained'
        db.delete_column('lizard_waterbalance_openwater', 'undrained_id')
