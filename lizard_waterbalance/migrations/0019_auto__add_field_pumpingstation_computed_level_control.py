...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PumpingStation.computed_level_control'
        db.add_column('lizard_waterbalance_pumpingstation', 'computed_level_control', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PumpingStation.computed_level_control'
        db.delete_column('lizard_waterbalance_pumpingstation', 'computed_level_control')
