...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'TimeseriesFews.name_parameter'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'name_parameter')

        # Deleting field 'TimeseriesFews.name_location'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'name_location')

        # Adding field 'TimeseriesFews.pkey'
        db.add_column('lizard_waterbalance_timeseriesfews', 'pkey', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TimeseriesFews.fkey'
        db.add_column('lizard_waterbalance_timeseriesfews', 'fkey', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'TimeseriesFews.lkey'
        db.add_column('lizard_waterbalance_timeseriesfews', 'lkey', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'TimeseriesFews.name_parameter'
        db.add_column('lizard_waterbalance_timeseriesfews', 'name_parameter', self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True), keep_default=False)
        ...
        # Deleting field 'TimeseriesFews.pkey'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'pkey')

        # Deleting field 'TimeseriesFews.fkey'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'fkey')

        # Deleting field 'TimeseriesFews.lkey'
        db.delete_column('lizard_waterbalance_timeseriesfews', 'lkey')
