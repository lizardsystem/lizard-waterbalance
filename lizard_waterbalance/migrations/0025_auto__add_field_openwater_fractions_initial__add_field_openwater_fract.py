...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OpenWater.fractions_initial'
        db.add_column('lizard_waterbalance_openwater', 'fractions_initial', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_precipitation'
        db.add_column('lizard_waterbalance_openwater', 'fractions_precipitation', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_seepage'
        db.add_column('lizard_waterbalance_openwater', 'fractions_seepage', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_hardened'
        db.add_column('lizard_waterbalance_openwater', 'fractions_hardened', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_drained'
        db.add_column('lizard_waterbalance_openwater', 'fractions_drained', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_undrained'
        db.add_column('lizard_waterbalance_openwater', 'fractions_undrained', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)

        # Adding field 'OpenWater.fractions_flow_off'
        db.add_column('lizard_waterbalance_openwater', 'fractions_flow_off', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OpenWater.fractions_initial'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_initial_id')

        # Deleting field 'OpenWater.fractions_precipitation'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_precipitation_id')

        # Deleting field 'OpenWater.fractions_seepage'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_seepage_id')

        # Deleting field 'OpenWater.fractions_hardened'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_hardened_id')

        # Deleting field 'OpenWater.fractions_drained'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_drained_id')

        # Deleting field 'OpenWater.fractions_undrained'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_undrained_id')

        # Deleting field 'OpenWater.fractions_flow_off'
        db.delete_column('lizard_waterbalance_openwater', 'fractions_flow_off_id')
