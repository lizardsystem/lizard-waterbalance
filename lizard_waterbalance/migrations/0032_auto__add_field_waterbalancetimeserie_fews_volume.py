...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterbalanceTimeserie.fews_volume'
        db.add_column('lizard_waterbalance_waterbalancetimeserie', 'fews_volume', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.TimeseriesFews']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterbalanceTimeserie.fews_volume'
        db.delete_column('lizard_waterbalance_waterbalancetimeserie', 'fews_volume_id')
