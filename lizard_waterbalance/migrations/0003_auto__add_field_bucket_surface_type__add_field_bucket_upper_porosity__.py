...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bucket.surface_type'
        db.add_column('lizard_waterbalance_bucket', 'surface_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'Bucket.upper_porosity'
        db.add_column('lizard_waterbalance_bucket', 'upper_porosity', self.gf('django.db.models.fields.FloatField')(default=1.0), keep_default=False)

        # Adding field 'Bucket.upper_crop_evaporation_factor'
        db.add_column('lizard_waterbalance_bucket', 'upper_crop_evaporation_factor', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)

        # Adding field 'Bucket.upper_min_crop_evaporation_factor'
        db.add_column('lizard_waterbalance_bucket', 'upper_min_crop_evaporation_factor', self.gf('django.db.models.fields.FloatField')(default=0.0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Bucket.surface_type'
        db.delete_column('lizard_waterbalance_bucket', 'surface_type')

        # Deleting field 'Bucket.upper_porosity'
        db.delete_column('lizard_waterbalance_bucket', 'upper_porosity')

        # Deleting field 'Bucket.upper_crop_evaporation_factor'
        db.delete_column('lizard_waterbalance_bucket', 'upper_crop_evaporation_factor')

        # Deleting field 'Bucket.upper_min_crop_evaporation_factor'
        db.delete_column('lizard_waterbalance_bucket', 'upper_min_crop_evaporation_factor')
