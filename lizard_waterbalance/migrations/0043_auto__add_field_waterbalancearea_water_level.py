...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterbalanceArea.water_level'
        db.add_column('lizard_waterbalance_waterbalancearea', 'water_level', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', null=True, to=orm['lizard_waterbalance.WaterbalanceTimeserie']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterbalanceArea.water_level'
        db.delete_column('lizard_waterbalance_waterbalancearea', 'water_level_id')
    ...
    models = {
        ...
        'lizard_waterbalance.waterbalancearea': {
            ...
            'water_level': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'null': 'True', 'to': "orm['lizard_waterbalance.WaterbalanceTimeserie']"})
        },
