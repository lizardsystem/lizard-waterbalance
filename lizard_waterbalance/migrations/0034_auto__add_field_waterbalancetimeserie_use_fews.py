...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'WaterbalanceTimeserie.use_fews'
        db.add_column('lizard_waterbalance_waterbalancetimeserie', 'use_fews', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'WaterbalanceTimeserie.use_fews'
        db.delete_column('lizard_waterbalance_waterbalancetimeserie', 'use_fews')
