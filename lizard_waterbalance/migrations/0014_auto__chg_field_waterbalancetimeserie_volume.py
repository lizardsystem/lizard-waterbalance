...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'volume_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_waterbalance.Timeseries']))


    def backwards(self, orm):
        
        # Changing field 'WaterbalanceTimeserie.volume'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'volume_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_fewsunblobbed.Timeserie']))
    ...
    models = {
        ...
        'lizard_waterbalance.waterbalancetimeserie': {
            ...
            'volume': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'+'", 'to': "orm['lizard_waterbalance.Timeseries']"})
        }
    }
