...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'sulfate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Timeseries']))

        # Changing field 'WaterbalanceTimeserie.phosphate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'phosphate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Timeseries']))

        # Changing field 'WaterbalanceTimeserie.nitrate'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'nitrate_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Timeseries']))

        # Changing field 'WaterbalanceTimeserie.chloride'
        db.alter_column('lizard_waterbalance_waterbalancetimeserie', 'chloride_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lizard_waterbalance.Timeseries']))
