...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Concentration.minimum'
        db.alter_column('lizard_waterbalance_concentration', 'minimum', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'Concentration.increment'
        db.alter_column('lizard_waterbalance_concentration', 'increment', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Concentration.minimum'
        db.alter_column('lizard_waterbalance_concentration', 'minimum', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Concentration.increment'
        db.alter_column('lizard_waterbalance_concentration', 'increment', self.gf('django.db.models.fields.IntegerField')(null=True))
